...
### ⚠️ Currently under development. Bugs and crashes may still happen. ⚠️
 ...
 * 🔄️ **Regular Updates**: New features are added every month, ensuring Demido stays fresh and exciting.
 * 🎛️ **User-Friendly Commands**: Easy-to-use commands to control playback, manage queues, and customize your listening experience.
...
### 🎧 Music
* `/play <song name>` Starts playing the song you have specified. If you use this command multiple times, the new 
...
### 🛠️ Utilities
* `/avatar <user>` Shows the avatar image of the selected user.
